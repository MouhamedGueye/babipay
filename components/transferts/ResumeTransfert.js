...
import { styles } from './ResumeTransfertStyles';


class ResumeTransfert extends React.Component {
        ...
        return (
            <View style={styles.view_intra} hide={this.state.isVisibleOngletWallet}
                ...
                <View style={styles.bloc_recap}>
                        ...
                        <Text style={styles.text_tire}>Bénéficiare</Text>
                        <Text style={styles.texte_valeur}>{this.state.beneficiaire}</Text>
                ...
                <ScrollView style={styles.generalViewScrol}>
                    ...
                    <Modal isVisible={this.state.isModalVisible}
                        ...
                        <View style={styles.modal_succes}>
                            ...
                            <Text style={styles.text_succes1}>Transfert effectué</Text>
...
export default ResumeTransfert;